...
as 
	select e.employeeId, e.fullname, e.position, e.salary, br.branchName, br.location
    from employees e
    join branch br on br.branchID = e.branchID;

-- 3
create view HighSalaryEmployees
as
	select e.employeeID, e.fullname, e.position, e.salary
    from employees e
...
as   
	select e.employeeId, e.fullname, e.position, e.salary, br.branchName, br.location, phoneNumber
    from employees e
    join branch br on br.branchID = e.branchID;
